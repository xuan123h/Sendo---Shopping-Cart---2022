          ...
          <div className="lg:w-[1356px] h-[100%] w-[375px]">
            ...
            <div className="lg:flex lg:items-center justify-between mt-[20px] h-[649px] bg-[#FFFFFF]">
              ...
              <div className="lg:w-[500px] lg:h-[500px] w-[200px]">
                {/* Slider con */}
                <div className="lg:mt-[-40px] lg:ml-7 translate-x-12 translate-y-2">
                  <Swiper
                    style={{
              ...
              <div className="lg:mr-10 lg:mt-0 mt-6">
                <div className="lg:w-[715px] h-[40px] backgroundUrl flex items-center w-[375px]">
                  ...
                  <div className="flex items-center absolute lg:ml-[500px] ml-[140px]">
                    ...
                    <div className="w-[98px] h-[24px] bg-[#27343F] p-1">
                ...
                <div className="flex items-center mt-12 justify-between">
                  <span className="lg:w-[51px] h-[18px] text-[#B7BBBF] text-[14px] lining-nums:translate-x-0 translate-x-2 ">
                    {new Intl.NumberFormat("de-DE", {
                      style: "currency",
                      currency: "VND",
            ...
            <div className="flex items-center justify-between h-[269px] bg-[#FFFFFF] mt-4">
              {/* Left */}
              ...
              <div className="-translate-x-10">
                ...
                <div>
                  ...
                  <p className="w-[712px] h-[54px] text-[#3F4B53] text-[14px]">
                    {" "}
                    {product.description}{" "}
                  </p>
                </div>
                <div className="w-[715px] h-[40px] text-[#3F4B53] text-[13.5px] bg-[#E7E8EA] pt-[11px] pb-[11px] pl-[16px] pr-[16px] flex items-center justify-center mt-3">
            ...
            <div className="mt-4 h-[449px] bg-[#FFFFFF]">
              <div className="flex items-center ml-10">
                <h4 className="w-[296px] h-[18px] text-[#0F1E29] text-[20px]">
                  {" "}
              ...
              <div className="mt-4 ml-10">
                <div>
                  <div>
                    ...
                    <p className="w-[345.5px] h-[36px] text-[#828282] text-[14px] mt-2">
                      {" "}
              ...
              <div className="flex items-center text-[14px] mt-6 ml-4">
              ...
              <div className="mt-4 ml-4">
                <div className="flex items-center">
                  ...
                  <div className="w-[51px] h-[19px] flex items-center ml-[-160px]">
                    <span>
                      {" "}
                      <box-icon name="star" color="green"></box-icon>{" "}
                    </span>
                ...
                <p className="w-[631px] h-[18px] text-[#0F1E29] text-[14px] mt-2">
                  {" "}
