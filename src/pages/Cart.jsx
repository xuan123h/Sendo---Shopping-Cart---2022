...
import Information from "../components/ProductHot/Information";
...
const Cart = () => {
  ...
  const cartItems = (product) => {
    return (
      <>
        <div className="mt-[100px] lg:ml-[331px] relative lg:w-[1300px] h-[155px] border border-white bg-white rounded-lg">
          <div className="">
